...
package body Protocol_Buffers.IO.Coded_Input_Stream is
   ...
   begin
      ...
      pragma Compile_Time_Warning (Standard.True, "Read_String unimplemented");
      raise Program_Error with "Unimplemented function Read_String";
      return Read_String (The_Coded_Input_Stream);
   end Read_String;
