...
package Protocol_Buffers.IO.Coded_Output_Stream is
   ...
   procedure Write_String (The_Coded_Output_Stream : in Coded_Output_Stream.Instance; Field_Number : in TMP_FIELD_TYPE; Value : in Ada.Strings.Unbounded.Unbounded_String);
   ...
   procedure Write_String_No_Tag (The_Coded_Output_Stream : in Coded_Output_Stream.Instance; Value : in Ada.Strings.Unbounded.Unbounded_String);
