...
--               To.Set_Name (Protocol_Buffers.Wire_Format.TMP_String (Ada.Strings.Unbounded.To_String (From.Name));
    ...
    begin
      ...
      -- optional string name = 2;
      if The_Message.Has_Name then
        Protocol_Buffers.IO.Coded_Output_Stream.Write_String (The_Coded_Output_Stream, 2, Protocol_Buffers.Wire_Format.TMP_String(Ada.Strings.Unbounded.To_String(The_Message.Name)));
      end if;
        ...
        when 2 =>
               if Protocol_Buffers.Wire_Format.Get_Tag_Wire_Type (Tag) =
                 Protocol_Buffers.Wire_Format.LENGTH_DELIMITED then
                  The_Message.Name := Ada.Strings.Unbounded.To_Unbounded_String (String(The_Coded_Input_Stream.Read_String));
