...
package body Unittest.ForeignMessage is
  ---------------------------------------------------------------------------
  -- Inherited functions and procedures from Protocol_Buffers.Message -------
  ---------------------------------------------------------------------------

  procedure Clear
    (The_Message : in out Unittest.ForeignMessage.Instance) is
  begin
  ...
  procedure Copy
    (To   : in out Unittest.ForeignMessage.Instance;
     From : in Unittest.ForeignMessage.Instance) is
  begin
    To.Clear;
    To.Merge (From);
  end Copy;
  ...
  function Get_Type_Name
    (The_Message : in Unittest.ForeignMessage.Instance) return Protocol_Buffers.Wire_Format.PB_String is
  begin
    return "protobuf_unittest.ForeignMessage";
  end Get_Type_Name;

  function Is_Initialized
    (The_Message : in Unittest.ForeignMessage.Instance) return Boolean is
  begin
    return True;
  end Is_Initialized;
  ...
  function Byte_Size
    (The_Message : in out Unittest.ForeignMessage.Instance) return Protocol_Buffers.Wire_Format.PB_Object_Size is
    Total_Size : Protocol_Buffers.Wire_Format.PB_Object_Size := 0;
  begin
    if (The_Message.Has_Bits (0 / 32) and Protocol_Buffers.Wire_Format.Shift_Left (16#FF#, 0 mod 32)) /= 0 then
      -- optional int32 c = 1;
      if The_Message.Has_C then
        Total_Size := Total_Size + 1 + Protocol_Buffers.IO.Coded_Output_Stream.Compute_Integer_32_Size_No_Tag (The_Message.C);
      end if;
    end if;
  ...
  begin
    -- optional int32 c = 1;
    if The_Message.Has_C then
      Protocol_Buffers.IO.Coded_Output_Stream.Write_Integer_32 (The_Coded_Output_Stream, 1, The_Message.C);
    end if;
  ...
  function Get_Cached_Size
    (The_Message : in Unittest.ForeignMessage.Instance) return Protocol_Buffers.Wire_Format.PB_Object_Size is
  begin
  ...
  -- optional int32 c = 1;
  function Has_C
    (The_Message : in ForeignMessage.Instance) return Boolean is
  begin
    return (The_Message.Has_Bits(0) and 16#00000001#) /= 0;
  end Has_C;

  procedure Set_Has_C
    (The_Message : in out ForeignMessage.Instance) is
  begin
  ...
  function Get_C
    (The_Message : in ForeignMessage.Instance) return Protocol_Buffers.Wire_Format.PB_Int32 is
  begin
