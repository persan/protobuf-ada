...
package Protocol_Buffers.IO.Invalid_Protocol_Buffer_Exception is
  ...
  Recursion_Limit_Exceeded_Message : constant String :=
    ...
    "Use Protocol_Buffers.IO.Coded_Input_Stream.setRecursionLimit(...) to " &
    "increase the depth limit.";

  Size_Limit_Exceeded_Message : constant String :=
    "Protocol message was too large. May be malicious. " &
    "Use Protocol_Buffers.IO.Coded_Input_Stream.setSizeLimit(...) to " &
