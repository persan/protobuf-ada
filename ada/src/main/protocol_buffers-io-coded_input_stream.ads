...
-- dependency caused by with-ing Protocol_Buffers.IO.Coded_Input_Stream from
...
package Protocol_Buffers.IO.Coded_Input_Stream is
  ...
  procedure Read_Message (This : in out Coded_Input_Stream.Instance; Value : in out Protocol_Buffers.Message.Instance'Class);
